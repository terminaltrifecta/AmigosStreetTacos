        ...
        <div className="terms-page-container">
            <div className="terms-content-wrapper">
                ...
                <div className="terms-section">
                    ...
                    <p className="terms-paragraph">
                        Prices displayed on the Website [choose one and clearly state: include sales tax / do not include sales tax,
                        with sales tax added at checkout]. Delivery fees or other service charges, if applicable, will be clearly displayed
